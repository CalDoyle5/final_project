...
# class Coach(Person):
#     def __init__(
#         self, id: int, first_name: str, last_name: str, age: int, roster: Roster
#     ):
...
#     def __init__(
#         self, id: int, first_name: str, last_name: str, age: int, scout_id: int, 
#     ):
#         super().__init__(id, first_name, last_name, age)
...
# class Trade():
#     def __init__(self, id: int, scout_id: int, team_id: int, player_id: int, coach_id: int, date: date,):
        
#         super().__init__(id, scout_id)
